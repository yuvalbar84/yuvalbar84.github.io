  ...
  function getSecondHeaderData (data) {
    ...
    if (data.settings) {
      returnObj = {
        ...
        sellOnlyModeClass: data.settings.hasOwnProperty('sellOnlyMode') && data.settings.sellOnlyMode ? PBConstants.NEGATIVE_BADGE : PBConstants.POSITIVE_BADGE,
        sellOnlyModeOverride: data.settings.hasOwnProperty('sellOnlyModeOverride') ? data.settings.sellOnlyModeOverride.toString() : '',
        sellOnlyModeOverrideClass: data.settings.hasOwnProperty('sellOnlyModeOverride') && data.settings.sellOnlyModeOverride ? PBConstants.NEGATIVE_BADGE : PBConstants.POSITIVE_BADGE,
        sellOnlyModeToolTip: data.settings.sellOnlyMode && data.settings.sellOnlyModeTrigger ? data.settings.sellOnlyModeTrigger : '',
        configEnabled: isEnableConfig ? PBConstants.ON : PBConstants.OFF,
        configEnabledClass: isEnableConfig ? PBConstants.POSITIVE_BADGE : PBConstants.NEGATIVE_BADGE,
        passwordSet: isPasswordSet ? PBConstants.ON : PBConstants.OFF,
