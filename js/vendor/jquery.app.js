...
!(function ($) {
  ...
  Sidemenu.prototype.openLeftBar = function () {
    ...
    // To expand and collapse the sidemenu on click on menu icon.
    $('.side-menu').slideToggle(400, 'swing', function () {
        // To fix the issue of some menu list items are not appearing 
        // when we open menu in ios.
        // To fix that we are changing style of menu list items and ios redraws the
        // UI when any item style changes and we will get all the menu list.
        $('#sidebar-menu ul li').css('z-index', zIndexes[currentZIndex]);
        currentZIndex++;
        if (currentZIndex === 3) {
            currentZIndex = 0;
        }
